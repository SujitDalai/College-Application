...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category","SOET","SOM","SOL","SOE"};
    ...
    private void uploadImage() {
        ...
        bitmap.compress(Bitmap.CompressFormat.JPEG, 50,baos); // Setting the quality of the image (compressing)
